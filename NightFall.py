...
print("\n")
print("NNNNNNNN        NNNNNNNN  iiii                     hhhhhhh                     tttt          FFFFFFFFFFFFFFFFFFFFFF                lllllll lllllll ",)
print("N:::::::N       N::::::N i::::i                    h:::::h                  ttt:::t          F::::::::::::::::::::F                l:::::l l:::::l ",)
print("N::::::::N      N::::::N  iiii                     h:::::h                  t:::::t          F::::::::::::::::::::F                l:::::l l:::::l ",)
print("N:::::::::N     N::::::N                           h:::::h                  t:::::t          FF::::::FFFFFFFFF::::F                l:::::l l:::::l ",)
print("N::::::::::N    N::::::Niiiiiii    ggggggggg   gggggh::::h hhhhh      ttttttt:::::ttttttt      F:::::F       FFFFFFaaaaaaaaaaaaa    l::::l  l::::l ",)
print("N:::::::::::N   N::::::Ni:::::i   g:::::::::ggg::::gh::::hh:::::hhh   t:::::::::::::::::t      F:::::F             a::::::::::::a   l::::l  l::::l ",)
print("N:::::::N::::N  N::::::N i::::i  g:::::::::::::::::gh::::::::::::::hh t:::::::::::::::::t      F::::::FFFFFFFFFF   aaaaaaaaa:::::a  l::::l  l::::l ",)
print("N::::::N N::::N N::::::N i::::i g::::::ggggg::::::ggh:::::::hhh::::::htttttt:::::::tttttt      F:::::::::::::::F            a::::a  l::::l  l::::l ",)
print("N::::::N  N::::N:::::::N i::::i g:::::g     g:::::g h::::::h   h::::::h     t:::::t            F:::::::::::::::F     aaaaaaa:::::a  l::::l  l::::l ",)
print("N::::::N   N:::::::::::N i::::i g:::::g     g:::::g h:::::h     h:::::h     t:::::t            F::::::FFFFFFFFFF   aa::::::::::::a  l::::l  l::::l ",)
print("N::::::N    N::::::::::N i::::i g:::::g     g:::::g h:::::h     h:::::h     t:::::t            F:::::F            a::::aaaa::::::a  l::::l  l::::l ",)
print("N::::::N     N:::::::::N i::::i g::::::g    g:::::g h:::::h     h:::::h     t:::::t    tttttt  F:::::F           a::::a    a:::::a  l::::l  l::::l ",)
print("N::::::N      N::::::::Ni::::::ig:::::::ggggg:::::g h:::::h     h:::::h     t::::::tttt:::::tFF:::::::FF         a::::a    a:::::a l::::::ll::::::l",)
print("N::::::N       N:::::::Ni::::::i g::::::::::::::::g h:::::h     h:::::h     tt::::::::::::::tF::::::::FF         a:::::aaaa::::::a l::::::ll::::::l",)
print("N::::::N        N::::::Ni::::::i  gg::::::::::::::g h:::::h     h:::::h       tt:::::::::::ttF::::::::FF          a::::::::::aa:::al::::::ll::::::l",)
print("NNNNNNNN         NNNNNNNiiiiiiii    gggggggg::::::g hhhhhhh     hhhhhhh         ttttttttttt  FFFFFFFFFFF           aaaaaaaaaa  aaaallllllllllllllll",)
print("                                            g:::::g                                                                                                ",)
print("                                gggggg      g:::::g                                                                                                ",)
print("                                g:::::gg   gg:::::g                                                                                                ",)
print("                                 g::::::ggg:::::::g                                                                                                ",)
...
print(colored("\n    Nightfall: those who lurk will fall in the night","yellow"))
print(colored("           - By: NoAssosciation (@noassosciation on tele for custom tools)\n", "red"))
